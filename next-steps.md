...
1. Modify or add environment variables to configure the running application. Environment variables can be configured by modifying the `env` node in the following files:
    - [app/my-react-tasks.bicep](./infra/app/my-react-tasks.bicep)
...
- [app/my-react-tasks.bicep](./infra/app/my-react-tasks.bicep) - Azure Container Apps resources to host the 'my-react-tasks' service.
